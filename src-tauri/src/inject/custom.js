...
${downloadUrl}`);
  ...
  function initializeMobileCourseHeaderLayout() {
    ...
    const ensureHeaderHost = () => {
      ...
      if (menuToggleBar) {
        menuToggleBar.insertAdjacentElement("afterbegin", headerHost);
      } else if (spacer) {
